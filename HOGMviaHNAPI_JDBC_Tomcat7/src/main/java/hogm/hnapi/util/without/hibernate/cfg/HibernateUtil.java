...
public class HibernateUtil {
    ...
    static {
        try {
            ...
            // use the default direct JDBC transactions		
            cfgogm.setProperty(Environment.TRANSACTION_STRATEGY, "org.hibernate.transaction.JDBCTransactionFactory");
            // bind "current session" to the current Java thread
            cfgogm.setProperty(Environment.CURRENT_SESSION_CONTEXT_CLASS, "thread");
