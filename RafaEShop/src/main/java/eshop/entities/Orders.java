...
public class Orders implements Serializable {
	...
	private static final long serialVersionUID = 7742386410781930429L;
	...
	@IndexedEmbedded
	@ElementCollection(targetClass=eshop.embedded.CartProducts.class, fetch=FetchType.EAGER)
	@AttributeOverrides( {
		...
		@AttributeOverride(name = "color", column = @Column(name = "product_color")),
		...
		@AttributeOverride(name = "uin", column = @Column(name = "unique_identification_number")),
	})
